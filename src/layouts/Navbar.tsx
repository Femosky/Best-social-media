...
export const Navbar: React.FC = () => {
    ...
    return (
        <>
            ...
            {isSmall && (
                <aside
                    className={`grid z-[999] fixed top-0 inset-0 overflow-y-hidden bg-white min-w-full min-h-full h-screen w-screen shrink-0 | md:transition-all md:w-[28rem] md:min-w-0 md:right-0 md:rounded-l-2xl`}
                >
